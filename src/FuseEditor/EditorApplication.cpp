...
void EditorApplication::onImGui() {
    ...
    if (isDockingEnable) {
        ...
        if (ImGui::DockBuilderGetNode(dockspaceId) == nullptr) {
            ...
            ImGuiID dockIdLeft   = ImGui::DockBuilderSplitNode(dock_main_id,
                                                             ImGuiDir_Left,
                                                             0.2f,
                                                             nullptr,
                                                             &dock_main_id);
            ImGuiID dockIdRight  = ImGui::DockBuilderSplitNode(dock_main_id,
                                                              ImGuiDir_Right,
                                                              0.2f,
                                                              nullptr,
                                                              &dock_main_id);
            ImGuiID dockIdBottom = ImGui::DockBuilderSplitNode(dock_main_id,
                                                               ImGuiDir_Down,
                                                               0.20f,
                                                               nullptr,
                                                               &dock_main_id);
            ...
            ImGui::DockBuilderDockWindow("Console##Console", dockIdBottom);
